...
import { chooseCardContent } from "@/lib/revision/chooseCardContent";
...
import { FlashcardAnswerBlurComponent } from "@/components/revision/FlashcardAnswerBlurComponent";
import { RevisionActionButton } from "@/components/revision/RevisionActionButton";
        ...
        >
          <View className="flex flex-row items-start grow">
            <View className="flex flex-row items-center gap-1 opacity-50">
              <Icons.ArrowArcLeft size={15} color="black" />
        ...
        >
          <View className="flex flex-row justify-end items-start grow">
            <View className="flex flex-row items-center gap-1 opacity-50">
              ...
              <Icons.ArrowArcRight size={15} color="black" />
            </View>
          </View>
        </TouchableWithoutFeedback>
      </Animated.View>
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Icons.ChevronRight size={18} color={"#4b5563"} strokeWidth={2.5} />
        </RevisionActionButton>
      </Animated.View>
    );
  }
